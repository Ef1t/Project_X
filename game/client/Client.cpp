...
//Client::Client(const std::string &host, unsigned short port, const std::string &username, sf::RenderWindow &window)
//        : m_window (window), m_objects(), is_map(false), this_player_id(0),
//          is_creator(false) {
